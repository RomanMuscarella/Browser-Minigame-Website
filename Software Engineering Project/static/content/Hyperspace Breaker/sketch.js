...
function preload() {
  gameFont = loadFont("Ethnocentric.otf");
}
//////////////////// SETUP ////////////////////
function setup() {
  textFont(gameFont);
  ...
  sfx.paddle = loadSound("pop.mp3");
  sfx.brick = loadSound("popbrick.mp3");
  sfx.loseLife = loadSound("fail.mp3");
  music = loadSound("cerise.mp3");
